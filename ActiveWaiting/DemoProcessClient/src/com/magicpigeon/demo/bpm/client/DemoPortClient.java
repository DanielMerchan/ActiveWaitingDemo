...
public class DemoPortClient {
    public static void main(String[] args) {
        DemoService demoService = new DemoService();
        DemoPortType demoPortType = demoService.getDemoPort();

        // Configure credential providers
        Map<String, Object> requestContext = ((BindingProvider) demoPortType).getRequestContext();
